...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, importance_score, radii, geomBuffer, binningBuffer, imgBuffer, invdepths = _C.rasterize_gaussians(*args)
        ...
        return color, radii, invdepths, importance_score

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, grad_out_depth, grad_importance_score):
