...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
        ...
        self.semantic_width = self.semantic_feature.shape[2]
        self.semantic_height = self.semantic_feature.shape[1]
        ...
        self.semantic_focal_y = self.semantic_height / (2.0 * tan_fovy)
        self.semantic_focal_x = self.semantic_width / (2.0 * tan_fovx)
...
class Camera_Pose(nn.Module):
    def __init__(self,start_pose_w2c, FoVx, FoVy, image_width, image_height,
        ...
        self.w = nn.Parameter(torch.zeros(size=(3,)).to(start_pose_w2c.device))
        self.v = nn.Parameter(torch.zeros(size=(3,)).to(start_pose_w2c.device))
