...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]): 
        ...
        """
        print("foundation model: ", args.foundation_model)
    ...
    def save(self, iteration):
        ...
        with open(os.path.join(point_cloud_path, "gaussians.txt"), 'w') as file:
            file.write("number of gaussians: {}".format(self.gaussians.get_num_gaussians))
